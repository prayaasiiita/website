        ...
        <main className="min-h-screen bg-white text-(--ngo-dark)">
            <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16 sm:pt-28 md:pt-32">
                ...
                <div className="space-y-8 text-base sm:text-lg leading-relaxed text-(--ngo-gray)">
                    <section>
                        <h2 className="text-xl sm:text-2xl font-semibold text-(--ngo-dark) mb-3">1. Acceptance of terms</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-semibold text-(--ngo-dark) mb-3">2. About Prayaas</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-semibold text-(--ngo-dark) mb-3">3. Eligibility</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-semibold text-(--ngo-dark) mb-3">4. Accounts and access</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-semibold text-(--ngo-dark) mb-3">5. Acceptable use</h2>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-semibold text-(--ngo-dark) mb-3">6. Content ownership</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-semibold text-(--ngo-dark) mb-3">7. Donations</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-semibold text-(--ngo-dark) mb-3">8. Third-party links</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-semibold text-(--ngo-dark) mb-3">9. Disclaimers</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-semibold text-(--ngo-dark) mb-3">10. Limitation of liability</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-semibold text-(--ngo-dark) mb-3">11. Indemnity</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-semibold text-(--ngo-dark) mb-3">12. Termination</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-semibold text-(--ngo-dark) mb-3">13. Governing law</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-semibold text-(--ngo-dark) mb-3">14. Changes to terms</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-xl sm:text-2xl font-semibold text-(--ngo-dark) mb-3">15. Contact</h2>
                        <p>
                            For questions about these terms, contact us at <a className="text-(--ngo-orange) hover:underline" href="mailto:prayaas@iiita.ac.in">prayaas@iiita.ac.in</a>.
                        </p>
                    </section>
                </div>
            </section>
