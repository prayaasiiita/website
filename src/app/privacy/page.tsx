        ...
        <main className="min-h-screen bg-white text-(--ngo-dark)">
            <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                <div className="space-y-8 text-lg leading-relaxed text-(--ngo-gray)">
                    <section>
                        <h2 className="text-2xl font-semibold text-(--ngo-dark) mb-3">1. Who we are</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-(--ngo-dark) mb-3">2. Information we collect</h2>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-(--ngo-dark) mb-3">3. How we use information</h2>
                        <ul className="list-disc pl-6 space-y-2">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-(--ngo-dark) mb-3">4. Sharing and disclosure</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-(--ngo-dark) mb-3">5. Cookies and analytics</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-(--ngo-dark) mb-3">6. Data retention</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-(--ngo-dark) mb-3">7. Your choices</h2>
                        <ul className="list-disc pl-6 space-y-2">
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-(--ngo-dark) mb-3">8. Security</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-(--ngo-dark) mb-3">9. Children&apos;s privacy</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-(--ngo-dark) mb-3">10. Changes to this policy</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="text-2xl font-semibold text-(--ngo-dark) mb-3">11. Contact</h2>
                        <p>
                            For questions or requests about this policy, contact us at <a className="text-(--ngo-orange)" href="mailto:prayaas@iiita.ac.in">prayaas@iiita.ac.in</a>.
                        </p>
                    </section>
                </div>
            </section>
