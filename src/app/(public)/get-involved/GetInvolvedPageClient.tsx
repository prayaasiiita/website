        ...
        <section id="donate" className="py-24 bg-white scroll-mt-24">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {donationTiers.map((tier, index) => (
                        ...
                        >
                            ...
                            <div className="text-center mb-6">
                                <span
                                    className={`text-4xl font-bold ${tier.popular ? "text-white" : "text-(--ngo-orange)"
                                        }`}
                                    style={{ fontFamily: "'Playfair Display', serif" }}
                                >
                                    {tier.amount}
                                ...
                                <h3
                                    className={`text-xl font-bold mt-2 ${tier.popular ? "text-white" : "text-(--ngo-dark)"
                                        }`}
                                >
                                    {tier.title}
                                </h3>
                                <p
                                    className={`mt-2 ${tier.popular ? "text-white/80" : "text-(--ngo-gray)"
                                        }`}
                                >
                                    {tier.description}
                                </p>
                            ...
                            <ul className="space-y-3 mb-8">
                                {tier.features.map((feature) => (
                                    <li key={feature} className="flex items-center gap-2">
                                        <CheckCircle
                                            className={`w-5 h-5 shrink-0 ${tier.popular ? "text-white" : "text-(--ngo-green)"
                                                }`}
                                        />
                                        <span
                                            className={
                ...
                >
                    ...
                    <Link
                        href="/contact-us"
                        className="inline-flex items-center gap-2 px-6 py-3 bg-(--ngo-green) text-white rounded-full font-semibold hover:bg-(--ngo-green-light) transition-colors"
                    >
    ...
    return (
        <section className="py-24 bg-(--ngo-dark) relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-10">
                <Image
                    src={getImageSrc(images, "cta", "background", "")}
                    alt=""
                    fill
                    className="object-cover"
                />
