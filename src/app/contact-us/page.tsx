...
function FAQSection() {
  const faqs = [
    {
      question: "How can I volunteer with Prayaas?",
      answer:
        "Visit our Get Involved page and fill out the volunteer application form. We'll get back to you within 48 hours to discuss opportunities.",
    },
    {
      question: "Are donations tax-deductible?",
      answer:
        "Yes, donations to Prayaas are eligible for tax benefits under Section 80G. We provide receipts for all donations.",
    },
    {
      question: "Can I visit the learning center?",
      answer:
        "Absolutely! We welcome visitors. Please contact us in advance to schedule a visit during our class hours (weekends 10 AM - 1 PM).",
    },
    {
      question: "How is my donation used?",
      answer:
        "Your donation goes directly towards educational materials, event organization, and program development. We maintain complete transparency in fund usage.",
    },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6">
          {faqs.map((faq, index) => (
            ...
            >
              <h3 className="text-lg font-bold text-(--ngo-dark) mb-2">
                {faq.question}
              </h3>
              <p className="text-(--ngo-gray)">{faq.answer}</p>
            </motion.div>
          ))}
        </div>
      </div>
