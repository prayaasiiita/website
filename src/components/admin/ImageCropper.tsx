...
export function ImageCropper({
    ...
    return (
        <div className="fixed inset-0 bg-black/95 z-100 flex flex-col">
            {/* Header */}
            <div className="bg-linear-to-r from-gray-900/95 to-gray-800/95 border-b border-gray-700/50 px-6 py-4 flex items-center justify-between shadow-lg backdrop-blur-md">
            ...
            {/* Controls */}
            <div className="bg-linear-to-r from-gray-900/95 to-gray-800/95 border-t border-gray-700/50 px-6 py-2 shadow-2xl backdrop-blur-md">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        <Button
                            onClick={handleCrop}
                            className="flex-1 bg-linear-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:scale-[1.02] active:scale-[0.98] transition-all border border-blue-500/20"
                            disabled={isProcessing}
                        >
                            {isProcessing ? (
                                <>
